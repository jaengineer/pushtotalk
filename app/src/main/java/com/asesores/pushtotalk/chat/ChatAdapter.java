package com.asesores.pushtotalk.chat;
...
/***  BASEADAPTER: para crear un adapter personalizado para nuestro chat **********/
public class ChatAdapter extends BaseAdapter {
	
//	private static final String DATE_FORMAT = "yyyy-MM-dd hh:mm:ss";
	
	
	private static final String DATE_FORMAT = "hh:mm";  /*** para poner el formato de la fecha ********/
